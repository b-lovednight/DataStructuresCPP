...
namespace csv {
  ...
  Row &Parser::getRow(unsigned int rowPosition) const
  {
      ...
      throw Error("can't return this row 1 (doesn't exist)");
  }
  ...
  {
      if (pos >= _header.size())
        throw Error("can't return this header 2 (doesn't exist)");
      return _header[pos];
  }
  ...
  */
  ...
  const std::string Row::operator[](unsigned int valuePosition) const
  {
       ...
       throw Error("can't return this value 3 (doesn't exist)");
  }
  ...
  const std::string Row::operator[](const std::string &key) const
  {
      ...
      throw Error("can't return this value 4 (doesn't exist)");
  }
